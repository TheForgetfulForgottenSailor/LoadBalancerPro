...
```bash
java -jar target/LoadBalancerPro-2.3.4.jar --server.address=127.0.0.1 --server.port=18080 --spring.profiles.active=local
```
...
java -jar target/LoadBalancerPro-2.3.4.jar --server.address=127.0.0.1 --server.port=18080 --spring.profiles.active=prod
```
...
```bash
LOADBALANCERPRO_API_KEY=replace-with-random-local-test-value \
java -jar target/LoadBalancerPro-2.3.4.jar --server.address=127.0.0.1 --server.port=18080 --spring.profiles.active=cloud-sandbox
```
...
```bash
java -jar target/LoadBalancerPro-2.3.4.jar --lase-demo
java -jar target/LoadBalancerPro-2.3.4.jar --lase-demo=all
java -jar target/LoadBalancerPro-2.3.4.jar --lase-demo=healthy
java -jar target/LoadBalancerPro-2.3.4.jar --lase-demo=overloaded
java -jar target/LoadBalancerPro-2.3.4.jar --lase-demo=error-storm
java -jar target/LoadBalancerPro-2.3.4.jar --lase-demo=partial-outage
java -jar target/LoadBalancerPro-2.3.4.jar --lase-demo=low-sample
...
```bash
mvn package
java -jar target/LoadBalancerPro-2.3.4.jar --lase-replay=shadow-events.jsonl
```

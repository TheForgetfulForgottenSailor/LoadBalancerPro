...
- [GitHub Release v2.4.1](https://github.com/richmond423/LoadBalancerPro/releases/tag/v2.4.1) is the compatibility-maintenance release for deprecated-shim caller cleanup, the cloud metrics wrapper refactor, and README/CODEOWNERS/docs polish.
- [`docs/V2_4_1_COMPATIBILITY_MAINTENANCE_RELEASE.md`](docs/V2_4_1_COMPATIBILITY_MAINTENANCE_RELEASE.md) summarizes the v2.4.1 maintenance scope and compatibility posture.
...
```bash
java -jar target/LoadBalancerPro-2.4.1.jar --server.address=127.0.0.1 --server.port=18080 --spring.profiles.active=local
```
...
java -jar target/LoadBalancerPro-2.4.1.jar --server.address=127.0.0.1 --server.port=18080 --spring.profiles.active=prod
```
...
```bash
LOADBALANCERPRO_API_KEY=replace-with-random-local-test-value \
java -jar target/LoadBalancerPro-2.4.1.jar --server.address=127.0.0.1 --server.port=18080 --spring.profiles.active=cloud-sandbox
```
...
```bash
mvn package
java -jar target/LoadBalancerPro-2.4.1.jar --lase-demo=healthy
```
...
```bash
java -jar target/LoadBalancerPro-2.4.1.jar --lase-demo
java -jar target/LoadBalancerPro-2.4.1.jar --lase-demo=all
java -jar target/LoadBalancerPro-2.4.1.jar --lase-demo=healthy
java -jar target/LoadBalancerPro-2.4.1.jar --lase-demo=overloaded
java -jar target/LoadBalancerPro-2.4.1.jar --lase-demo=error-storm
java -jar target/LoadBalancerPro-2.4.1.jar --lase-demo=partial-outage
java -jar target/LoadBalancerPro-2.4.1.jar --lase-demo=low-sample
java -jar target/LoadBalancerPro-2.4.1.jar --lase-demo=invalid-name
```
...
```bash
mvn package
java -jar target/LoadBalancerPro-2.4.1.jar --lase-replay=shadow-events.jsonl
```

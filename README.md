...
```bash
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --server.address=127.0.0.1 --server.port=18080 --spring.profiles.active=local
```
...
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --server.address=127.0.0.1 --server.port=18080 --spring.profiles.active=prod
```
...
```bash
LOADBALANCERPRO_API_KEY=replace-with-random-local-test-value \
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --server.address=127.0.0.1 --server.port=18080 --spring.profiles.active=cloud-sandbox
```
...
```bash
mvn package
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-demo=healthy
```
...
```bash
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-demo
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-demo=all
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-demo=healthy
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-demo=overloaded
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-demo=error-storm
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-demo=partial-outage
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-demo=low-sample
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-demo=invalid-name
```
...
```bash
mvn package
java -jar target/LoadBalancerPro-1.0.0-rc6.jar --lase-replay=shadow-events.jsonl
```
